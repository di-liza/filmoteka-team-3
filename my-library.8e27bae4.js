 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e,t,n))),a.forEach((n=>{const i=function(e,t,n){return"value"===t.type||"child_removed"===t.type||(t.prevName=n.getPredecessorChildName(t.childName,t.snapshotNode,e.index_)),t}(e,n,o);r.forEach((r=>{r.respondsTo(n.type)&&t.push(r.createEvent(i,e.query_))}))}))}function Mt(e,t){return{eventCache:e,serverCache:t}}function Ft(e,t,n,i){return Mt(new Lt(t,n,i),e.serverCache)}function Ut(e,t,n,i){return Mt(e.eventCache,new Lt(t,n,i))}function Bt(e){return e.eventCache.isFullyInitialized()?e.eventCache.getNode():null}function zt(e){return e.serverCache.isFullyInitialized()?e.serverCache.getNode():null}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const gn=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class yn{constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Lt(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return dn(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:zt(this.viewCache_),r=hn(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pr=i.SDK_VERSION,h=Pr,(0,i._registerComponent)(new(0,r.Component)("database",((e,{instanceIdentifier:t})=>Rr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(c,u,Lr),(0,i.registerVersion)(c,u,"esm2017")})),o.register("5OC5t",(function(t,n){e(t.exports,"showTrailer",(function(){return l}));var i=o("fXyif"),r=o("7Y9D8");const s=new(0,i.GetMovie);document.querySelector(".movie-collection").addEventListener("click",(e=>{if("BUTTON"===e.target.nodeName){const t=e.target.closest("button"),{id:n}=t?.dataset||{};l(n)}}));let a="";async function l(e){try{const{results:t}=await s.getMovieTrailer(e);console.log(t);const n=t.find((e=>"Trailer"===e.type));if(n&&"Trailer"!==n.type)return;a=n?n.key:"",async function(e){const t=document.querySelector(".modal-content"),n=document.querySelector(".modal-btn-cross__icon");if(c.classList.add("modal--show"),document.body.classList.add("stop-scrolling"),t.innerHTML=`<iframe\n  class="modal-video"\n  alt="Trailer"\n  src="https://www.youtube.com/embed/${e}"\n  ></iframe> `,localStorage.getItem("theme"))return n.classList.add("dark"),t.classList.add("dark");if(!localStorage.getItem("theme"))n.classList.remove("dark"),t.classList.remove("dark")}(a)}catch(e){r.Notify.failure(e.message)}}const c=document.querySelector(".modal-video-container");document.querySelector(".modal-close-btn").addEventListener("click",(()=>h()));const u=document.querySelector(".modal-content");function h(){c.classList.remove("modal--show"),document.body.classList.remove("stop-scrolling"),u.innerHTML=""}window.addEventListener("click",(e=>{e.target===c&&h()})),window.addEventListener("keydown",(e=>{27===e.keyCode&&h()}))}));
//# sourceMappingURL=my-library.8e27bae4.js.map
