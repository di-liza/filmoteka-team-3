 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Pr=i.SDK_VERSION,d=Pr,(0,i._registerComponent)(new(0,o.Component)("database",((e,{instanceIdentifier:t})=>Rr(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,i.registerVersion)(c,u,Lr),(0,i.registerVersion)(c,u,"esm2017")})),r.register("5OC5t",(function(t,n){e(t.exports,"showTrailer",(function(){return l}));var i=r("fXyif"),o=r("7Y9D8");const s=new(0,i.GetMovie);document.querySelector(".movie-collection").addEventListener("click",(e=>{if("BUTTON"===e.target.nodeName){const t=e.target.closest("button"),{id:n}=t?.dataset||{};l(n)}}));let a="";async function l(e){try{const{results:t}=await s.getMovieTrailer(e);console.log(t);const n=t.find((e=>"Trailer"===e.type));if(n&&"Trailer"!==n.type)return;a=n?n.key:"",async function(e){const t=document.querySelector(".modal-content"),n=document.querySelector(".modal-btn-cross__icon");if(c.classList.add("modal--show"),document.body.classList.add("stop-scrolling"),t.innerHTML=`<iframe\n  class="modal-video"\n  alt="Trailer"\n  src="https://www.youtube.com/embed/${e}"\n  ></iframe> `,localStorage.getItem("theme"))return n.classList.add("dark"),t.classList.add("dark");if(!localStorage.getItem("theme"))n.classList.remove("dark"),t.classList.remove("dark")}(a)}catch(e){o.Notify.failure(e.message)}}const c=document.querySelector(".modal-video-container");document.querySelector(".modal-close-btn").addEventListener("click",(()=>d()));const u=document.querySelector(".modal-content");function d(){c.classList.remove("modal--show"),document.body.classList.remove("stop-scrolling"),u.innerHTML=""}window.addEventListener("click",(e=>{e.target===c&&d()})),window.addEventListener("keydown",(e=>{27===e.keyCode&&d()}))})),r.register("1VOaQ",(function(e,t){const n=new(0,r("b2dIo").default)(".glide",{type:"slider",startAt:0,perView:1}),i=document.querySelector('[data-footer="open"]'),o=document.querySelector("body"),s=document.querySelector(".team-member-modal"),a=document.querySelector(".team-member-modal__close-btn");function l(e){"Escape"===e.key&&s.classList.add("hidden")}function c(){s.classList.add("hidden")}window.addEventListener("click",(e=>{e.target===s&&c()})),i.addEventListener("click",(function(){s.classList.remove("hidden"),o.classList.add("modal-open"),document.addEventListener("keydown",l),n.mount(),a.addEventListener("click",c)}))})),r.register("b2dIo",(function(t,n){
/*!
 * Glide.js v3.6.0
...
//# sourceMappingURL=my-library.ed5d1e3c.js.map
